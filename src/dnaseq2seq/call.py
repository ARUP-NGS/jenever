...
def call_vars_in_parallel(
    ...
    A total footgun here is that pytorch releases tensors generated by a Process when that process dies, even if they've been added to a shared queue (!!). So the 'generate_tensors'
